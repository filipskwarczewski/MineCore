...
public class healCommand implements CommandExecutor {
	...
	public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label,
		...
		if(args.length == 1) {
			...
			target.setHealth(20);
			sender.sendMessage(Component.text(target.getName() + " has been healed!",TextColor.color(0x39db64)));
			target.sendMessage(Component.text("You have been healed by " + sender.getName(),TextColor.color(0x39db64)));
			return false;
		}
		...
		p.setHealth(20);
		p.sendMessage(Component.text("You have been healed!",TextColor.color(0x39db64)));
		return true;
	}
